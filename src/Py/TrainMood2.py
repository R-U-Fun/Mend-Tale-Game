...
# Load the data
with open('../../datasets/MT_DS_HP1_Mood_Bal_v1.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
model = Sequential([
    Embedding(input_dim=5000, output_dim=64, input_length=16),
    Flatten(),
...
model.save("../../mt_ml_models/MT_DS_HP1_Mood_Bal_v1_Model")
